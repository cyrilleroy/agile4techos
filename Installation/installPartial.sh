...
mvn install:install-file -DgroupId=org.agile4techos.nokiatest -DartifactId=questionType -Dpackaging=jar -Dfile=$workspaceDir/QuestionsType/src/questionType-1.0.0.jar -DpomFile=$workspaceDir/QuestionsType/pom.xml
